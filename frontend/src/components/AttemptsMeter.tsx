...
export function AttemptsMeter({ remaining, max }: Props) {
  return (
    <div className="flex items-center gap-1.5">
      <span className="text-xs text-gray-500 font-mono mr-0.5 tracking-wider">LIVES</span>
      {Array.from({ length: max }, (_, i) => {
        ...
        return (
          <div
            key={i}
            className="w-4 h-4 rounded flex items-center justify-center text-[11px] transition-all duration-300"
            style={{
